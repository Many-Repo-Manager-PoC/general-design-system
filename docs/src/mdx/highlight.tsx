...
export const Highlight = component$(
  ({
    ...
    return (
      ...
      >
        <pre class="whitespace-pre-wrap max-h-[31.25rem] max-w-full overflow-y-auto rounded-lg bg-gradient-to-b bg-charcoal-50 border-2 border-gray-20 py-4 text-sm text-black">
